...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	$data = $_POST['data_plan_ct'];
	$data = explode("/", $data);
    $data = $data[2]."-".$data[1]."-".$data[0];
  $insertSQL = sprintf("INSERT INTO plano_contas (data_plan_ct, clin_id_plan_ct, nome_plan_ct, cadastrador_plan_ct) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($data, "date"),
                       GetSQLValueString($_POST['clin_id_plan_ct'], "int"),
                       GetSQLValueString($_POST['nome_plan_ct'], "text"),
                       GetSQLValueString($_POST['cadastrador_plan_ct'], "text"));
		...
		<!-- Identifica Usuario Logado -->		
                   <?php include('../restrito/identifica01.php');?>
					...
					<div class="col-md-8 ser-fet">
						<h3>:..Plano de Contas - Cadastro..:</h3>
			             ...
			             <div class="w3-container">
                                ...
                                <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                                  <table width="100%" border="0" align="center" cellpadding="10" cellspacing="10">
                                    <tr valign="baseline">
                                      <td width="11%" align="right" nowrap>Data:</td>
                                      <td width="89%" align="left"><input type="text" name="data_plan_ct" value="" size="10">
                                       <input TYPE="button" NAME="btndata_plan_ct" VALUE="..." Onclick=   "javascript:popdate('document.form1.data_plan_ct','pop1','150',document.form1.data_plan_ct.value)">
                                    ...
                                    <tr valign="baseline">
                                      ...
                                      <td align="left"><span id="spryselect1">
                                        <select name="clin_id_plan_ct" id="clin_id_plan_ct">
                                    ...
                                    <tr valign="baseline">
                                      ...
                                      <td align="left"><span id="sprytextfield1">
                                        <input name="nome_plan_ct" type="text" value="" size="32" maxlength="80">
                                      <span class="textfieldRequiredMsg">Obrigatorio.</span></span></td>
                                    </tr>
                                    <tr valign="baseline">
                                      <td nowrap align="right">Cadastrador:</td>
                                      <td align="left"><input type="text" name="cadastrador_plan_ct" value="<?php  echo $_SESSION['MM_Username'];?>" 
