...
$query_cs_lancamento = sprintf("SELECT id_lanc, data_lanc, lancamento.clin_id, med_id, pac_id, conv_id, proc_id, valor_lanc, pag_id, tx_mat_med_lanc, cadastrador_lanc, id_med, nome_med, repasse_proc, repasse_cons, repasse_exam, id_clin, nome_clin FROM lancamento, medico, clinica WHERE med_id = %s AND id_med=med_id AND id_clin=lancamento.clin_id ORDER BY data_lanc ASC", GetSQLValueString($colname_cs_lancamento, "int"));
                       ...
                       <?php include('../restrito/Menu_lateral.php');?>  
						...
						<div class="features">
							<div>
                             ...
                             <h4>Resultado..:</h4>
                             <br>
                             <p>Nome Selecionado: <?php echo $row_cs_lancamento['nome_med']; ?></p>
							 <?php
                             ...
                             <table width="100%" border="1" cellpadding="10" cellspacing="10">
                               <tr>
                                 <td width="12%" align="center" bgcolor="#999999"><strong>DATA</strong></td>
                                 <td width="20%" align="center" bgcolor="#999999"><strong>CLÍNICA</strong></td>
                                 <td width="12%" align="center" bgcolor="#999999"><strong>VALOR R$</strong></td>
                                 <td width="15%" align="center" bgcolor="#999999"><strong>TAXA_MAT_MED</strong></td>
                                 <td width="12%" align="center" bgcolor="#999999"><strong>TOTAL R$</strong></td>
                               </tr>
                               <?php do { ?>
                                 <tr>
                                   <td align="center"><?php echo $row_cs_lancamento['data_lanc']; ?></td>
                                   <td><?php echo $row_cs_lancamento['nome_clin']; ?></td>
                                   <td align="right"><?php echo number_format($row_cs_lancamento['valor_lanc'],2); ?></td>
                                   <td align="right"><?php echo number_format($row_cs_lancamento['tx_mat_med_lanc'],2); ?></td>
                                   <td align="center"><?php 
								                           $valor1=$row_cs_lancamento['valor_lanc'];
														   $taxa1=$row_cs_lancamento['tx_mat_med_lanc'];
														   $repasse=$row_cs_lancamento['repasse_proc'];
														   $repassecs=$row_cs_lancamento['repasse_cons'];
														   $repasseex=$row_cs_lancamento['repasse_exam'];
														   $calc=(($valor1+$taxa1)*($repasse/100));
                                ...
                                <table width="100%" border="0" cellspacing="10" cellpadding="10">
                                   <tr>
                                     ...
                                     <td width="13%" >&nbsp;</td>
                                     <td width="42%" >&nbsp;</td>
                                     <td width="16%" ><strong>Total Procedimento R$</strong></td>
                                     <td width="16%" align="right" ><strong><center><?php 
									                                                   $v1=$row_cs_total['sum(valor_lanc)'];
																					   $t1=$row_cs_total['sum(tx_mat_med_lanc)'];
																					   $soma=(($v1+$t1)*($repasse/100));																					   
																					   echo number_format($soma,2); ?></center></strong></td>
                                   </tr>
								   <tr>
                                     <th width="13%" scope="row">&nbsp;</th>
                                     <td width="13%" >&nbsp;</td>
                                     <td width="42%" >&nbsp;</td>
                                     <td width="50%" ><strong>Total Consulta R$</strong></td>
                                     <td width="16%" align="right" ><strong><center><?php 
									                                                   $v1=$row_cs_total['sum(valor_lanc)'];
																					   $t1=$row_cs_total['sum(tx_mat_med_lanc)'];
																					   $soma=(($v1+$t1)*($repassecs/100));																					   
																					   echo number_format($soma,2); ?></center></strong></td>
                                   </tr>
								   <tr>
                                     <th width="13%" scope="row">&nbsp;</th>
                                     <td width="13%" >&nbsp;</td>
                                     <td width="42%" >&nbsp;</td>
                                     <td width="16%" ><strong>Total Exame R$</strong></td>
                                     <td width="16%" align="right" ><strong><center><?php 
									                                                   $v1=$row_cs_total['sum(valor_lanc)'];
																					   $t1=$row_cs_total['sum(tx_mat_med_lanc)'];
																					   $soma=(($v1+$t1)*($repasseex/100));																					   
																					   echo number_format($soma,2); ?></center></strong></td>
                                    </tr>
                                 </table>
								 <?php } else {			   
