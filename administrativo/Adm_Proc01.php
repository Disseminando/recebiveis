...
if (isset($_POST[$MM_flag])) {
  ...
  $loginUsername = $_POST['nome_proc'];
  $LoginRS__query = sprintf("SELECT nome_proc FROM procedimentos WHERE nome_proc=%s", GetSQLValueString($loginUsername, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO procedimentos (cod_proc, nome_proc, situacao_proc, cadastrador_proc) VALUES (%s, %s, %s, %s)",
                                        ...
                                        <table width="100%" border="0" align="center" cellpadding="10" cellspacing="10">
                                          <tr valign="baseline">
                                            ...
                                            <td width="86%"><span id="sprytextfield1">
                                              <input name="cod_proc" type="text" value="" size="10" maxlength="9">
                                            <span class="textfieldRequiredMsg">Obrigatorio.</span></span></td>
                                          </tr>
                                          <tr valign="baseline">
                                            <td nowrap align="right"><strong>Nome:</strong></td>
                                            <td><span id="sprytextfield2">
                                              <input name="nome_proc" type="text" value="" size="32" maxlength="255">
                                            <span class="textfieldRequiredMsg">Obrigatorio.</span></span></td>
                                          </tr>
                                          <tr valign="baseline">
                                          ...
                                          <tr valign="baseline">
                                            ...
                                            <td><input type="text" name="cadastrador_proc" value="<?php  echo $_SESSION['MM_Username'];?>" size="20" maxlength="20" readonly="readonly"></td>
                                          </tr>
                                          <tr valign="baseline">
