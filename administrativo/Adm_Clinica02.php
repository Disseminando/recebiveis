		...
		<?php include('../restrito/Menu_lateral.php');?>        
					<div class="col-md-8 ser-fet">
                        ...
                        <br>
                           ...
                           Informe o Nome: <input name="clinica" type="text" size="30" maxlength="20">
                           <input type="submit" name="ok" id="ok" value="Consultar" class="btn-success">
                           </form>
                          <br>
                          <h4>Resultado..:</h4>
                          <span class="line"></span>  
                           ...
                           <?php
                            ...
                            <table width="auto" border="0" cellpadding="5" cellspacing="5">
                             <tr>
                               ...
                               <td width="25%" bgcolor="#CCCCCC"><strong>Contato</strong></td>
                             </tr>
                             <?php do { ?>                                         
                               <tr>
                                 ...
                                 <td><?php echo $row_cs_clinica['contato_clin']; ?></td>                                             
                             </tr>
